    ...
    async def start(self):
        ...
        if CHANNEL_ID:
            try:
                ...
                self.LOGGER(__name__).info("\nBot failed to initialize correctly. Join https://t.me/Anime_Hindi_Fix for support")
        else:
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote> Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @Anime_Hindi_Fix</blockquote></b>")
        except: pass
