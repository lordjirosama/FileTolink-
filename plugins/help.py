...
👉 <b><a href="https://t.me/Howtodownloadhindiin/18">ᴄʟɪᴄᴋ ʜᴇʀᴇ ꜰᴏʀ ᴛᴜᴛᴏʀɪᴀʟ 🎬</a></b></blockquote>
<b>» ᴄᴏᴍᴍᴀɴᴅꜱ:</b>
    ...
    await client.send_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("• ᴏᴡɴᴇʀ", url="https://t.me/Senpai_jiro", style="success"),
                    InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ •", url="https://t.me/Fix_Chat_Group", style="success")
                ],
                [
                    InlineKeyboardButton("• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ •", url="https://t.me/Anime_Hindi_Fix", style="success")
                ],
            ]
        )
    )
